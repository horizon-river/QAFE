...
ALTER TABLE article ADD COLUMN goodReactionPoint INT(10) NOT NULL DEFAULT 0;

# 게시물 테이블에 badReactionPoint 칼럼 추가
ALTER TABLE article ADD COLUMN badReactionPoint INT(10) NOT NULL DEFAULT 0;
...
# 댓글 테이블에 인덱스 걸기
ALTER TABLE `QAFE`.`reply` ADD INDEX (`relTypeCode` , `relId`);
